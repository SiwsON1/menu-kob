...
async function uploadAll(generated) {
  ...
  console.log(`\nTworzenie folderu "Kobi Meble - Poprawki ${ITER_DATE} v2 (kategorie po audycie Slowik + produkty)" na Drive...`);
  const root = await createFolder(drive, `Kobi Meble - Poprawki ${ITER_DATE} v2 (kategorie po audycie Slowik + produkty)`);
