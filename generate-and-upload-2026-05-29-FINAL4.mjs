...
async function uploadAll(generated) {
  ...
  console.log(`\nTworzenie folderu "Kobi Meble - Poprawki ${ITER_DATE} FINAL-4 (z kart producenta, dash-free)" na Drive...`);
  const root = await createFolder(drive, `Kobi Meble - Poprawki ${ITER_DATE} FINAL-4 (z kart producenta, dash-free)`);
