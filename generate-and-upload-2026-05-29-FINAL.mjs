...
async function uploadAll(generated) {
  ...
  console.log(`\nTworzenie folderu "Kobi Meble - Poprawki ${ITER_DATE} FINAL (kategorie + produkty po audycie)" na Drive...`);
  const root = await createFolder(drive, `Kobi Meble - Poprawki ${ITER_DATE} FINAL (kategorie + produkty po audycie)`);
