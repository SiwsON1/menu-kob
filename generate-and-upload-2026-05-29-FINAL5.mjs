...
async function uploadAll(generated) {
  ...
  console.log(`\nTworzenie folderu "Kobi Meble - Poprawki ${ITER_DATE} - VERTO nowa metoda (do sprawdzenia)" na Drive...`);
  const root = await createFolder(drive, `Kobi Meble - Poprawki ${ITER_DATE} - VERTO nowa metoda (do sprawdzenia)`);
