...
async function uploadAll(generated) {
  ...
  console.log(`\nTworzenie folderu "Kobi Meble - Poprawki 2026-06-01 (10 nowych produktow)" na Drive...`);
  const root = await createFolder(drive, `Kobi Meble - Poprawki 2026-06-01 (10 nowych produktow)`);
