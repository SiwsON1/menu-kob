...
async function uploadAll(generated) {
  ...
  console.log(`\nTworzenie folderu "Kobi Meble - Poprawki ${ITER_DATE} FINAL-3 (produkty od nowa, pod czlowieka)" na Drive...`);
  const root = await createFolder(drive, `Kobi Meble - Poprawki ${ITER_DATE} FINAL-3 (produkty od nowa, pod czlowieka)`);
